...
__ajax = function(url, data, success, type ,contentType){
    ...
    config.beforeSend = function (xhr) {
        ...
        xhr.setRequestHeader("Access-Control-Allow-Methods", "OPTIONS,HEAD,GET,PUT,POST,DELETE,PATCH");
    }
...
AJAX = {
  GET:function(url, data, success){
    ...
    POST_JSON: function(url, data, success){
        __ajax(url, data, success, "post", "application/json;charset=UTF-8");
    },
    ...
    PATCH: function (url, data, success) {
        __ajax(url, data, success, "patch", "application/json;charset=UTF-8");
    },
